...
public class TrunkPlacerAndesite extends StraightTrunkPlacer {
    public static final Codec<TrunkPlacerAndesite> CODEC = RecordCodecBuilder.create(
            (instance) -> trunkPlacerParts(instance).apply(instance, TrunkPlacerAndesite::new));

    public TrunkPlacerAndesite(int baseHeight, int heightRandA, int heightRandB) {
    ...
    protected boolean placeLog(LevelSimulatedReader p_226176_, BiConsumer<BlockPos, BlockState> p_226177_, RandomSource p_226178_, BlockPos p_226179_, TreeConfiguration p_226180_, Function<BlockState, BlockState> p_226181_) {
        ...
        if (this.validTreePos(p_226176_, p_226179_)) {
            if (randomInt == 2) {
                // Generate Ore
                p_226177_.accept(p_226179_, Registry.BLOCK.get(new ResourceLocation("skyborne", "stone_log_andesite")).defaultBlockState());
            } else {
